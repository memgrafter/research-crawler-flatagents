-- Shotgun seed query for 2025 ML/LLM papers.
--
-- Notes:
-- - Uses fmr_score (no year-specific column yet for 2025).
-- - Filters to 2025 IDs and broad ML/LLM signals in title+abstract.
